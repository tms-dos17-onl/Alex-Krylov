...
sudo ls -l /boot | tee -a /home/user_with_group4/h | sudo echo ----- | tee -a /home/user_with_group4/h
sudo lsblk | tee -a /home/user_with_group4/h | sudo echo ------- | tee -a /home/user_with_group4/h
